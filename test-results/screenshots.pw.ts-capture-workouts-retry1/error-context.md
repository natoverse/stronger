...
- Name: screenshots.pw.ts >> capture workouts
...
Locator: locator('.workout-select')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.workout-select') with timeout 5000ms
  - waiting for locator('.workout-select')
