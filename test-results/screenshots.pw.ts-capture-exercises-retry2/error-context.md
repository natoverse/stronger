...
- Name: screenshots.pw.ts >> capture exercises
...
Locator: locator('.exercise-library')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.exercise-library') with timeout 5000ms
  - waiting for locator('.exercise-library')
