...
- Name: screenshots.pw.ts >> capture progress
...
Locator: locator('.progress-view')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.progress-view') with timeout 5000ms
  - waiting for locator('.progress-view')
