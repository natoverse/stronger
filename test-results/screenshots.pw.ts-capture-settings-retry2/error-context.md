...
- Name: screenshots.pw.ts >> capture settings
...
Locator: locator('.settings-view')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.settings-view') with timeout 5000ms
  - waiting for locator('.settings-view')
