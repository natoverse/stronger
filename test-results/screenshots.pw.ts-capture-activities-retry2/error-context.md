...
- Name: screenshots.pw.ts >> capture activities
...
Locator: locator('.activity-list-view')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.activity-list-view') with timeout 5000ms
  - waiting for locator('.activity-list-view')
