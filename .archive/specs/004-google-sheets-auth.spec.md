...
- **Interactive sign-in timing**: The 20-second timeout now applies only to silent refreshes. User-initiated sign-in remains open while the user completes Google account selection, password, two-factor authentication, or consent.
