...
- Activity cards sort newest first by their parsed ISO 8601 timestamp. Garmin sync stores that single timestamp rather than separate date and time fields; legacy date-only sheet rows normalize to local midnight.
