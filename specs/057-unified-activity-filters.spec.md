...
- Activity cards sort newest first by both calendar date and local start time. Garmin sync stores the local start time separately so activities on the same day have deterministic chronological order.
